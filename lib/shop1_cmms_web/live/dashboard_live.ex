defmodule Shop1CmmsWeb.DashboardLive do
  ...
  def render(assigns) do
    ...
    <div class="h-full flex flex-col p-3 gap-2 overflow-hidden">
      ...
      <div class="flex gap-2 flex-shrink-0" style="height: 120px; min-height: 120px;">
        <%= if @auth.view_work_orders do %>
          <div class="panel flex-1 min-w-0 flex flex-col overflow-hidden">
            <div class="panel-header flex-shrink-0">Work Orders</div>
            <div class="panel-body flex items-center justify-between p-3 overflow-hidden">
              <div class="min-w-0 flex-shrink-0">
                ...
                <div class="text-xs text-gray-500 mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">Open</div>
              </div>
              <div class="text-right min-w-0 ml-2 flex-shrink-0">
                <div class="text-xs text-red-600 font-medium whitespace-nowrap overflow-hidden text-ellipsis">0 Overdue</div>
                <div class="text-xxs text-gray-500 mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">0 Due Today</div>
              </div>
            </div>
          </div>
        <% end %>
          ...
          <.link href="/assets" class="panel flex-1 min-w-0 flex flex-col overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <div class="panel-body flex items-center justify-between p-3 overflow-hidden">
              <div class="min-w-0 flex-shrink-0">
                ...
                <div class="text-xs text-gray-500 mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">Total</div>
              </div>
              <div class="text-right min-w-0 ml-2 flex-shrink-0">
                <div class="text-xs text-green-600 font-medium whitespace-nowrap overflow-hidden text-ellipsis"><%= @stats.operational_assets %> Op.</div>
                <div class="text-xxs text-orange-600 mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis"><%= @stats.maintenance_assets %> Maint.</div>
              </div>
            </div>
          </.link>
        <% end %>
          ...
          <div class="panel flex-1 min-w-0 flex flex-col overflow-hidden">
            ...
            <div class="panel-body flex items-center justify-between p-3 overflow-hidden">
              <div class="min-w-0 flex-shrink-0">
                ...
                <div class="text-xs text-gray-500 mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">This Month</div>
              </div>
              <div class="flex items-center min-w-0 flex-shrink-0">
                <div class="text-xs text-gray-500 whitespace-nowrap overflow-hidden text-ellipsis">Coming Soon</div>
              </div>
            </div>
          </div>
        <% end %>
        ...
        <div class="panel flex-1 min-w-0 flex flex-col overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 text-white border-blue-600">
          ...
          <div class="panel-body flex items-center justify-between p-3 overflow-hidden">
            <div class="min-w-0 flex-shrink-0">
              ...
              <div class="text-xs opacity-90 mt-0.5 whitespace-nowrap overflow-hidden text-ellipsis">Uptime</div>
            </div>
            <div class="text-right min-w-0 ml-2 flex-shrink-0">
              <div class="flex items-center justify-end whitespace-nowrap overflow-hidden text-ellipsis">
      ...
      <div class="flex-1 flex gap-2 min-h-0 overflow-hidden">
                  ...
                  <%= for {status, count} <- @stats.by_status do %>
                    <div class="flex items-center justify-between p-2 bg-gray-50 rounded hover:bg-gray-100 transition-colors">
                      <div class="flex items-center min-w-0 flex-1 overflow-hidden">
                        ...
                        <span class="text-xs font-medium text-gray-700 capitalize truncate overflow-hidden text-ellipsis">
        ...
        <div class="panel flex-1 flex flex-col min-w-0 overflow-hidden">
          <div class="panel-header flex items-center justify-between flex-shrink-0">
            ...
            <div class="p-3 space-y-3">
              ...
              <div class="flex items-start space-x-3 p-3 bg-blue-50 rounded border border-blue-100">
                ...
                <div class="flex-1 min-w-0 overflow-hidden">
                  <p class="text-sm font-medium text-gray-900 truncate overflow-hidden text-ellipsis">Dashboard loaded successfully</p>
                  <p class="text-xs text-gray-600 mt-0.5 truncate overflow-hidden text-ellipsis">System initialized with <%= @stats.total_assets %> equipment items</p>
              ...
              <%= if @stats.total_assets > 0 do %>
                <div class="flex items-start space-x-3 p-3 bg-green-50 rounded border border-green-100">
                  ...
                  <div class="flex-1 min-w-0 overflow-hidden">
                    <p class="text-sm font-medium text-gray-900 truncate overflow-hidden text-ellipsis">Equipment database ready</p>
                    <p class="text-xs text-gray-600 mt-0.5 truncate overflow-hidden text-ellipsis"><%= @stats.operational_assets %> equipment operational, <%= @stats.maintenance_assets %> need attention</p>
                    <div class="flex items-center mt-1 space-x-2">
              ...
              <% else %>
                ...
                <div class="text-center py-12">
                  ...
                  <p class="mt-1 text-xs text-gray-500 max-w-md mx-auto">
                    Get started by adding your first equipment to see activity here.
                  </p>
                  <div class="mt-4">
